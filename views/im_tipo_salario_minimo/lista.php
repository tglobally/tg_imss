<?php /** @var \gamboamartin\im_registro_patronal\controllers\controlador_im_tipo_movimiento $controlador */ ?>
<?php
...
<?php include 'templates/im_tipo_salario_minimo/lista/secciones.php'; ?>
        ...
        <div class="col-md-12 mt-3 table-responsive-sm">
            ...
            <table class="table table-dark">
                ...
                <?php foreach ($controlador->registros as $registro) {?>
                    <tr>
                        <td><?php echo $registro->im_tipo_salario_minimo_id; ?></td>
                        <td><?php echo $registro->im_tipo_salario_minimo_codigo; ?></td>
                        <td><?php echo $registro->im_tipo_salario_minimo_codigo_bis; ?></td>
                        <td><?php echo $registro->im_tipo_salario_minimo_descripcion; ?></td>
                        <td><?php echo $registro->im_tipo_salario_minimo_descripcion_select; ?></td>
