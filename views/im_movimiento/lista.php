        ...
        <div class="col-md-12 mt-3 table-responsive-sm">
            ...
            <table class="table table-dark">
                ...
                <?php foreach ($controlador->registros as $registro){?>
                    <tr>
                        <td><?php echo $registro->im_movimiento_id; ?></td>
                        <td><?php echo $registro->im_movimiento_codigo; ?></td>
                        <td><?php echo $registro->im_movimiento_descripcion; ?></td>
                        <td><?php echo $registro->im_movimiento_descripcion_select; ?></td>
