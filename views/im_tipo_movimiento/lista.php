            ...
            <table class="table table-dark">
                ...
                <?php foreach ($controlador->registros as $registro){
                    ...
                    <tr>
                        ...
                        <th><?php echo $registro->im_tipo_movimiento_id; ?></th>
                        <th><?php echo $registro->im_tipo_movimiento_codigo; ?></th>
                        <th><?php echo $registro->im_tipo_movimiento_descripcion; ?></th>
                        <th><?php echo $registro->im_tipo_movimiento_descripcion_select; ?></th>
                    </tr>
                <?php } ?>
