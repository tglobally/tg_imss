        ...
        <div class="  form-main" id="form">
            <form method="post" action="./index.php?seccion=im_tipo_movimiento&accion=modifica_bd&session_id=<?php echo $controlador->session_id; ?>&resgistro_id=<?php echo $controlador->registro_id; ?>" class="form-additional">
                ...
                <div class="buttons col-md-12">
                    ...
                    <div class="col-md-6 ">
                        <a href="index.php?seccion=im_tipo_movimiento&accion=fiscales&session_id=<?php echo $controlador->session_id; ?>&resgistro_id=<?php echo $controlador->registro_id; ?>"  class="btn btn-info btn-guarda col-md-12 ">Siguiente</a>
                    </div>
                </div>
            </form>
        </div>
