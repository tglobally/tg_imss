...
class controlador_im_codigo_clase extends \gamboamartin\im_registro_patronal\controllers\controlador_im_codigo_clase {
    ...
    public function __construct(PDO $link, stdClass $paths_conf = new stdClass()){
        ...
        $this->seccion_titulo = "Codigos de Clase";
        $this->titulo_lista = 'Codigo Clase';
        $this->titulo_accion = "Listado de Codigos de Clase";
    ...
    public function alta(bool $header, bool $ws = false): array|string
    {
        ...
        $this->titulo_accion = "Alta Codigo de Clase";
    ...
    public function modifica(bool $header, bool $ws = false, array $keys_selects =  array()): array|stdClass
    {
        ...
        $this->titulo_accion = "Modifica Codigo de Clase";
