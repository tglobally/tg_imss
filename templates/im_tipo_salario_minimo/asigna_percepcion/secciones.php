<?php
/** @var \gamboamartin\nomina\controllers\controlador_nom_conf_nomina $controlador */
...
<div class="col-md-3 secciones">
    ...
    <div class="col-md-12 int_secciones ">
        ...
        <?php
        $data_template = (new menu_lateral())->contenido_menu_lateral(aplica_link:true,controlador:$controlador, titulo: 'Configuracion Nomina');
